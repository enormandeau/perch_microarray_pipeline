# Microarray Analysis program - Version 3.2
#
# Eric Normandeau
# 2011-02-16
...
# R-maanova code
#
# Warning!!! The code places the dyes in the
# same order as in the ScanArray .txt files!!!
# The Design File must be done accordingly
